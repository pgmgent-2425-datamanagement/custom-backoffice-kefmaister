                    ...
                    <?php foreach ($videos as $video): ?>
                        <tr class="hover:bg-gray-100 transition duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <img src="/thumbnails/<?= htmlspecialchars($video->thumbnail) ?>" alt="<?= htmlspecialchars($video->title) ?>" class="h-16 w-16 object-cover rounded">
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?= htmlspecialchars($video->duration) ?> minutes</td>
